...
- [TODO] `SN-OSA05` Add formula read/write parity probes from AppleScript.
...
- [TODO] `SN-OSA06` Add advanced object discovery for charts, pivots, styles, media, and formatting.
