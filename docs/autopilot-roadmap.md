...
Generated by `./scripts/autopilot_backlog_synthesis.sh` from policy signals:
- `todoFixmeCount=55`
...
- [TODO] `SN-AUTO-20260427-02` Add deterministic row delete guardrails for grouped tables.
...
- [TODO] `SN-AUTO-20260427-03` Add formula write validation for unsafe references.
...
- [TODO] `SN-AUTO-20260427-04` Harden pivot-linked write guard message specificity.
...
- [TODO] `SN-AUTO-20260427-05` Improve decode warning deduplication for unsupported payload nodes.
...
- [TODO] `SN-AUTO-20260427-06` Add pivot-link read diagnostics cardinality summary.
