...
| range-formatting-style-discovery | available | `range.format`, `range.font name`, `range.background color` | safe-read-only | format/style/rich-text read surfaces and guarded style-write backlog gaps |
